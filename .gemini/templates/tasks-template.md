...
- [ ] T005 [P] Implement authentication/authorization framework (Security First)
- [ ] T006 [P] Setup API routing and middleware structure
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling and structured JSON logging (Ops)
- [ ] T009 Setup environment configuration management
- [ ] T010 Verify Dockerfiles are up-to-date with new dependencies (Infra as Truth)
...
## Phase N-1: Browser Validation (REQUIRED for UI Features)

**Purpose**: Quality engineering - validate all UI features in the browser

**⚠️ MANDATORY**: All frontend features MUST be validated in browser before marking complete

### Manual Browser Testing
- [ ] TXXX Test all user flows in Chrome/Firefox/Safari
- [ ] TXXX Verify responsive design (mobile, tablet, desktop)
- [ ] TXXX Test all interactive elements (buttons, forms, modals)
- [ ] TXXX Verify animations and transitions
- [ ] TXXX Test error states and edge cases
- [ ] TXXX Verify accessibility (keyboard navigation, screen readers)
- [ ] TXXX Document validation with screenshots/recordings

### Automated E2E Tests (for critical journeys)
- [ ] TXXX [P] Write E2E test for primary user journey in tests/e2e/
- [ ] TXXX [P] Write E2E test for error handling in tests/e2e/
- [ ] TXXX Run E2E tests and verify all pass

**Checkpoint**: All UI features validated in browser - ready for polish
...
- [ ] TXXX [P] Update centralized docs/ (Architecture, Guides, ADRs) - Living Docs
- [ ] TXXX [P] Security Review (OWASP Top 10 check, Input Validation)
